...
public interface QCollapser
{
    ...
    public static Qubit collapse ( final Qubit q )
    {
        ...
        return decision.compareTo( onChance ) == -1 ?
            Qubit.QUBIT_ON :
                Qubit.QUBIT_OFF;
    }
     ...
     */
    public static List< String > generateCollapseData (
        final Qubit q ,
        final long n )
    {
    ...
    public static String collapseToString ( final QRegister reg )
    {
        ...
        final List< String > values =
            generateBinaryStringValues( QMath.log2( coeficients.length ) );
    ...
    public static CRegister collapse ( final QRegister reg , final long rounds )
    {
        ...
        final List< String > possibilities =
            generateBinaryStringValues( reg.size() );
    ...
    /**
     * NOTE: You should not be using this, if you want, do at your own
     * risk
     * 
     * @param   coefs
     ...
     *                         number fell
     * @apiNote            This is for internal use ONLY, do use at your
     *                         own risk
     */
