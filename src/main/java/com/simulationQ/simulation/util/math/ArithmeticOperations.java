 ...
 * all that us needed to implement is: add, multiply, negate and
 * invert, all
...
public interface ArithmeticOperations < T extends ArithmeticOperations< T > >
{
     ...
     * @return   a+b
     */
    public static < T extends ArithmeticOperations< T > > T add (
        final T a ,
        final T b )
    {
        return a.add( b );
     ...
     * @return   a-b
     */
    public static < T extends ArithmeticOperations< T > > T subtract (
        final T a ,
        final T b )
    {
        return a.subtract( b );
     ...
     * @return   a*b
     */
    public static < T extends ArithmeticOperations< T > > T multiply (
        final T a ,
        final T b )
    {
        return a.multiply( b );
     ...
     * @return   a/b
     */
    public static < T extends ArithmeticOperations< T > > T divide (
        final T a ,
        final T b )
    {
        return a.divide( b );
     ...
     * @return   a^n
     */
    public static < T extends ArithmeticOperations< T > > T pow (
        final T a ,
        final int n )
    {
        return a.pow( n );
