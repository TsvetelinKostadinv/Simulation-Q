...
public interface MatrixOperations extends ArithmeticOperations< Matrix >
{
     ...
     * @return   a*b
     */
    public static Matrix multiplyWithScalar (
     ...
     * 
     * @param  mapper
     *                    - a trifunction receiving the x, y and value and
     *                    producing the
     *                    new value
     * @return
     */
    public Matrix map (
        final TriFunction< Integer , Integer , ComplexNumber , ComplexNumber > mapper );
    ...
    /**
     * @param  matrix
     * @return        true if the number of rows equals the number of
     *                    colons, false
     *                    otherwise
     */
    public static < T > boolean isMatrixSquare ( final T [] [] matrix )
    {
        ...
        {
            if ( matrix[row].length != checkAgainst )
                return false;
        }
     ...
     * @param  a
     * @param  b
     * @return   true if the number of colons of matrix a equal the number
     *               of rows
     *               of matrix b and number of colons of matrix a equal
     *               the number of
     *               colons on matrix b
     */
    public static boolean areMatricesSameSize (
        final Matrix a ,
        final Matrix b )
    {
    ...
    public static Vector multiply ( final Matrix a , final Vector b )
    {
        if ( a.getColons() != b.size() )
        {
            ...
            throw new IllegalArgumentException(
                "The number of cols in the matrix should be equal to the number of elements in the vector" );
        }
