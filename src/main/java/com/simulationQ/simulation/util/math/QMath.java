...
public interface QMath
{
    ...
    public static final Supplier< BigDecimal > RND_SUPPLY =
     ...
     */
    public static boolean checkLinearCombinationEqualToOne (
        final BigDecimal a ,
        final BigDecimal b )
    {
        return a.pow( 2 )
     ...
     * 
     * @apiNote     as it returns <b>int</b> the supplied size should be a
     *                  power of
     *                  2
     * @param   num
     * @return      log2(size)
        ...
        switch ( num )
        {
            ...
            default :
                throw new IllegalArgumentException(
                    "This method works only with powers of 2" );
        }
    ...
    {
        if ( pow < 0 )
            throw new ArithmeticException( "The power must be greater than 0" );
