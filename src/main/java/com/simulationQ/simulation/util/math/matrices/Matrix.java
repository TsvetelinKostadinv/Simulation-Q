...
public class Matrix implements MatrixOperations
{
    ...
    public Matrix ( final ComplexNumber [] [] matrix )
    {
        ...
        if ( !MatrixOperations.isMatrixSquare( matrix ) )
            throw new IllegalArgumentException(
                "The matrix HAS to be rectangular" );
        this.matrix = matrix;
     ...
     */
    public static final ComplexNumber [] [] additionIdentity (
        final int rows ,
        final int colons )
    {
     ...
     */
    public static final Matrix multiplicativeIdentity (
        final int rows ,
        final int colons )
    {
        final ComplexNumber [] [] res = new ComplexNumber[rows][colons];
    ...
    /**
     * Sets the data on the specified row and colon with the specified
     * value
     * 
     * @param row
     * @param colon
    ...
    public boolean equals ( final Object obj )
    {
        ...
        for ( int row = 0 ; row < this.rows ; row++ )
        {
            ...
            {
                if ( !this.matrix[row][colon]
                    .equals( casted.matrix[row][colon] ) )
                {
                    return false;
                }
            }
    ...
    public String toString ()
    {
        ...
        {
            sb.append(
                Arrays.toString( this.matrix[row] )
