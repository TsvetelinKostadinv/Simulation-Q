...
class MatrixOperationsTest
{
     ...
     * [1 1]
     */
    public static final Matrix        sample2x2matrix_ones   = new Matrix( new ComplexNumber[][] {
            { ONE, ONE },
            { ONE, ONE }
    } );
     ...
     * [2 2]
     */
    public static final Matrix        sample2x2matrix_twoes  = new Matrix( new ComplexNumber[][] {
            { TWO, TWO },
            { TWO, TWO }
    } );
     ...
     * [4 4]
     */
    public static final Matrix        sample2x2matrix_fours  = new Matrix( new ComplexNumber[][] {
            { FOUR, FOUR },
            { FOUR, FOUR }
    } );
     ...
     * [4 4]
     */
    public static final Matrix        sample2x2matrix_eights = new Matrix( new ComplexNumber[][] {
            { EIGHT, EIGHT },
            { EIGHT, EIGHT }
    } );
    ...
    {
        final Matrix additionIdentity = new Matrix( Matrix.additionIdentity( sample2x2matrix_ones.getRows() ,
                                                                             sample2x2matrix_ones.getColons() ) );
        assertEquals( sample2x2matrix_ones.add( additionIdentity ) ,
        ...
        assertEquals( sample2x2matrix_ones ,
    ...
    final void testGetAt ()
    {
        ...
        assertThrows( IndexOutOfBoundsException.class ,
                      () -> {
                          sample2x2matrix_ones.getAt( sample2x2matrix_ones.getRows() ,
                                                      0 );
                      } );

        assertThrows( IndexOutOfBoundsException.class ,
                      () -> {
                          sample2x2matrix_ones.getAt( 0 ,
                                                      sample2x2matrix_ones.getColons() );
                      } );
    }
    ...
    final void testSetAt ()
    {
        ...
        assertThrows( IndexOutOfBoundsException.class ,
                      () -> {
                          sample2x2matrix_ones.setAt( 0 ,
                                                      -1 ,
                                                      ComplexNumber.ORIGIN );
                      } );

        assertThrows( IndexOutOfBoundsException.class , () -> {
            sample2x2matrix_ones.setAt( sample2x2matrix_ones.getRows() ,
                                        0 ,
                                        ComplexNumber.ORIGIN );
        } );
    ...
    final void testAdd ()
    {
        assertEquals( sample2x2matrix_ones.add( sample2x2matrix_ones ) ,
    ...
    {
        assertEquals( sample2x2matrix_ones.multiply( sample2x2matrix_twoes ) ,
    ...
    final void testPow ()
    {
        assertEquals( sample2x2matrix_twoes.pow( 2 ) ,
